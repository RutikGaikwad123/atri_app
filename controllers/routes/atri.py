...
class Atri:
	...
	@property
	def naveflex(self):
		self._getter_access_tracker["naveflex"] = {}
		return self._naveflex
	@naveflex.setter
	def naveflex(self, new_state):
		self._setter_access_tracker["naveflex"] = {}
		global default_state
		self._naveflex = Flex(new_state, default_state["naveflex"])
