...
export function usenaveflexCb() {
	const onClick = useCallback(callbackFactory("naveflex", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function usecompCb() {
	const onClick = useCallback(callbackFactory("comp", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
